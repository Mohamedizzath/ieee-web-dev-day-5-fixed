			...
			<Row className="align-middle">
				<Col md={{ span: 6, offset: 3 }}>
					<Card className="card-background">
						...
						<Card.Title className="center-text fonts"><h1>Register Form</h1></Card.Title>
							<Form>
								...
								<Form.Group className="mb-3" controlId="formBasicPassword">
									<Form.Label className="fonts"><h4>Confirm Password</h4></Form.Label>
									<Form.Control type="password" placeholder="Password"/>
								</Form.Group>
								<Link to="/" className="fonts">
									<Form.Text className="text-muted" className="fonts">Already have an account?</Form.Text>
								</Link>
								<br />
